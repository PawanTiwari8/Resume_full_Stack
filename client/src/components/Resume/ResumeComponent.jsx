...
const ResumeComponent = ({data}) => {
    console.log(data);
  return (
    <div class="bg-gray-100 p-4" id='resume'>

    <div class="w-[793px] h-[1122px] border-1 shadow-lg shadow-gray-700 rounded-lg" >
            ...
            <div class="flex flex-col sm:flex-row sm:mt-10">
                ...
                <div class="flex flex-col sm:w-1/3">
                    ...
                    <div class="py-3 sm:order-none order-2">
                        ...
                        <div>
                        {data.skills.map((s)=> (<div class="flex items-center my-1">
